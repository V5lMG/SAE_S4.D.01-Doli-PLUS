...
class DefaultComponentFactory implements ComponentFactory
{
    ...
    /**
     * @param string $controller_name the name of the controller to instantiate
    ...
    /**
     * Build and return a UsersService instance
     *
     * @return UsersService
     */
    ...
    /**
     * Build the HomeController and inject dependencies
     *
    ...
    /**
     * Build the ArticlesController and inject dependencies
     *
     * @return ArticlesController
     */
    private function buildArticlesController(): ArticlesController
    {
        return new ArticlesController($this->buildUsersService());
    }
