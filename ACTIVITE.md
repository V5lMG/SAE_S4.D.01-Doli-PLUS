...
Les requètes SQL ici ce retrouve dans le contrôleur au lieu d"un fichier modèle comme dans le fichier UsersServices de all_user.
...
Tout est mélangé, il faut donc séparer la vu, le modèle et le controller.
